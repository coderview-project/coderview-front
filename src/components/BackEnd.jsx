...
function BackEnd({formData, setFormData}) {
    return(
        <>
        <div >
        <label className="flex flex-col justify-center items-center" > ¿Qué capaz eres de gestionar las estructuras, el flujo y el almacenamiento de datos de una web? </label>
        <div className='image'>
        ...
        <label className="flex flex-col justify-center items-center"> ¿Y de de desarrollar algoritmos que ejecutan procesos lógicos? </label>
        <div className='image'>
         <img src={RangeSlider1}/>
        </div>
        <input className="RangeSlider" type="range" id="evaluation" name="evaluation"
