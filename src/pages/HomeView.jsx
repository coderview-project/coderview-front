...
function HomeView() {
    ...
    return (
        ...
        <div>
            <div>
                <img className="bg-top mt-36 h-auto w-full"
                src="src\assets\social-media-shorted.jpg"
                alt="background-home"></img>
            </div>
            <div className="bg-gradient-to-t from-orange ..."
                >   
                <p className="text-center object-fit text-2xl mb-8 pt-5 pb-5 h-auto bg-white font-poppins">¿Qué es CodeRview?</p>

                <p className="text-center leading-6 p-8 m-8 top-full bg-white h-auto rounded-xl font-poppins">CodeRview es una herramienta pedagógica diseñada para hacer y gestionar evaluaciones sobre el desempeño propio y de los compañeros durante procesos de aprendizaje, enfocada en particular al formato del Bootcamp. 
                
                <br></br> <br></br>
                
                De una forma rápida, divertida y visual tanto alumnos como formadores podrán acceder a un total de cuatro evaluaciones dispuestas a lo largo de las formaciones y ver la evolución en los conocimientos y la concepción propia de los alumnos.</p>
