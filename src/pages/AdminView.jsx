    ...
    return (
        ...
        <div>
            ...
            <div className="flex flex-col">
                <div className="Buttons-bootcamp flex justify-center float-right mt-6 text-xl font-poppins text-center">

                    <button type="button" className="Create flex flex-center"><img className="h-12 w-12 mt-1" src="src\assets\icon _plus circle_.png" alt="create-bootcamp"></img><p className="py-4 px-2">Crear Bootcamp</p></button>

                    <button type="button" className="Edit flex flex-center mx-10"><img className="h-12 w-12 mt-1" src="src\assets\icon _gear_.png" alt="edit-bootcamp"></img><p className="py-4 px-2">Editar Bootcamp</p></button>
                ...
                <div className="Photo flex justify-center flex-cols-2 font-poppins">
                    ...
                    <div className="flex flex-col text-center">
                        <div className="w-80 h-80 mb-8 ml-8">
