...
function AdminView() {
    ...
    return (
        ...
        <div className= "">
            ...
            <div className="Buttons-bootcamp flex float-right mx-10 my-28 text-xl font-poppins text-center">

                <button type="button" className="Create flex flex-center"><img className="h-16 w-16" src="src\assets\icon _plus circle_.png" alt="create-bootcamp"></img><p className="py-4 px-2">Crear Bootcamp</p></button>

                <button type="button" className="Edit flex flex-center mx-10"><img className="h-16 w-16" src="src\assets\icon _gear_.png" alt="edit-bootcamp"></img><p className="py-4 px-2">Editar Bootcamp</p></button>
            ...
            <div className="Photo flex flex-cols-2 font-poppins">
                ...
                <div className="Bootcamps mx-32 my-48 font-poppins">
