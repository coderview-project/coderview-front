                        ...
                        return (
                            <>
                                ...
                                <div className="flex flex-col mt-4 pl-20 mb-5 text-lg border-black border-2 border-solid rounded-xl w-3/4 justify-center">
                                    ...
                                    <h1 className="font-bold h-10 items-center"> Tu respuesta ha sido: {evaluation.projectM} / 6</h1><img id="WateringCan" src={WateringCan} alt="Evaluation result icon" />
                                    </div> 

                                    <p>¿Cómo de capaz eres de conceptualizar de manera funcional un proyecto digital?</p>
                                    <div className="flex items-baseline"> 
                                    <h1 className="font-bold h-10 items-center"> Tu respuesta ha sido: {evaluation.funcTech1} / 6</h1><img id="WateringCan" src={WateringCan} alt="Evaluation result icon" />
                                    </div>

                                    <p>¿Cómo de capaz eres de diseñar los procesos lógicos necesarios para un proyecto digital?</p>
                                    <div className="flex items-baseline"> 
                                    <h1 className="font-bold h-10 items-center"> Tu respuesta ha sido:{evaluation.funcTech2} / 6</h1><img id="WateringCan" src={WateringCan} alt="Evaluation result icon" />
                                    </div>

                                    <p>¿Y de explicar la solución adoptada y presentar el trabajo realziado sintetizando sus planteamientos y resultados?</p>
                                    <div className="flex items-baseline"> 
                                    <h1 className="font-bold h-10 items-center"> Tu respuesta ha sido: {evaluation.funcTech3} / 6</h1><img id="WateringCan" src={WateringCan} alt="Evaluation result icon" />
                                    </div>

                                    <p>¿Cómo de capaz eres de crear una UI web estática y adaptable?</p>
                                    <div className="flex items-baseline"> 
                                    <h1 className="font-bold h-10 items-center"> Tu respuesta ha sido: {evaluation.front1} / 6</h1> <img id="WateringCan" src={WateringCan} alt="Evaluation result icon" />
                                    </div>

                                    <p>¿Y de crear una UI web dinámica y adaptable?</p>
                                    <div className="flex items-baseline"> 
                                    <h1 className="font-bold h-10 items-center"> Tu respuesta ha sido: {evaluation.front2} / 6</h1><img id="WateringCan" src={WateringCan} alt="Evaluation result icon" />
                                    </div>

                                    <p>¿Qué capaz eres de gestionar las estructuras, el flujo y el almacenamiento de datos de una web?</p>
                                    <div className="flex items-baseline"> 
                                    <h1 className="font-bold h-10 items-center"> Tu respuesta ha sido: {evaluation.back1} / 6</h1><img id="WateringCan" src={WateringCan} alt="Evaluation result icon" />
                                    </div>

                                    <p>¿Y de de desarrollar algoritmos que ejecutan procesos lógicos?</p>
                                    <div className="flex items-baseline"> 
                                    <h1 className="font-bold h-10 items-center"> Tu respuesta ha sido: {evaluation.back2} / 6</h1><img id="WateringCan" src={WateringCan} alt="Evaluation result icon" />
                                    </div>

                                    <p>¿Cómo de capaz eres de implementar arquitecturas web escalables?</p>
                                    <div className="flex items-baseline"> 
                                    <h1 className="font-bold h-10 items-center"> Tu respuesta ha sido: {evaluation.archit} / 6</h1><img id="WateringCan" src={WateringCan} alt="Evaluation result icon" />
                                    </div>

                                    <p>¿Qué capaz eres de implementar prácticas y tecnologías para la gestión de versiones?</p>
                                    <div className="flex items-baseline"> 
                                    <h1 className="font-bold h-10 items-center"> Tu respuesta ha sido:{evaluation.qa1} / 6</h1><img id="WateringCan" src={WateringCan} alt="Evaluation result icon" />
                                    </div>

                                    <p>¿Cómo de capaz eres de implementar un código limpio y escalable?</p>
                                    <div className="flex items-baseline"> 
                                    <h1 className="font-bold h-10 items-center"> Tu respuesta ha sido: {evaluation.qa2} / 6</h1><img id="WateringCan" src={WateringCan} alt="Evaluation result icon" />
                                    </div>
